...
Write-Host "  4. Opcjonalnie poczta: konta w mail.accounts (config.json), mail.enabled = true, test:"
Write-Host "     .venv\Scripts\python.exe .claude\scripts\mail.py test"
